<?php
/**
 * Ocellaris Custom Footer Template
 * 
 * @package Ocellaris Custom Astra
 */
?>
<!-- newsletter cta section -->
 <div class="ocellaris-cta-section">
