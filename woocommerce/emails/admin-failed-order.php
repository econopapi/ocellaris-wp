...
$text = __( 'El pago de la orden #%1$s de %2$s ha fallado. La orden fue la siguiente:', 'woocommerce' );
if ( $email_improvements_enabled ) { 
	/* translators: %1$s: Order number. %2$s: Customer full name. */
	$text = __( 'Desafortunadamente, el pago de la orden #%1$s de %2$s ha fallado. La orden fue la siguiente:', 'woocommerce' );
}
?>
