...
$text = __( 'Este mensaje es una notificación para hacerte saber que el &mdash; pedido #%1$s perteneciente a %2$s ha sido cancelado:', 'woocommerce' );
if ( $email_improvements_enabled ) {
	/* translators: %1$s: Order number. %2$s: Customer full name */
	$text = __( 'Este mensaje de correo es para notificarte que el pedido #%1$s perteneciente a %2$s ha sido cancelado.', 'woocommerce' );
}
?>
