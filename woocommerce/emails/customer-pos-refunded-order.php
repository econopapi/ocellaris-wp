...
if ( $partial_refund ) {
	...
	echo sprintf( esc_html__( 'Tu pedido de %s ha sido parcialmente reembolsado.', 'woocommerce' ), esc_html( $pos_store_name ) ) . "\n\n";
} else {
	/* translators: %s: Site title */
	echo sprintf( esc_html__( 'Tu pedido de %s ha sido reembolsado.', 'woocommerce' ), esc_html( $pos_store_name ) ) . "\n\n";
}
echo '</p><p>';
echo esc_html__( 'Aquí tienes un resumen de lo que has comprado:', 'woocommerce' ) . "\n\n";
?>
</p>
</div>
